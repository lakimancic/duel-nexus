...
export const gameApi = {
  ...
  startGame: (roomId: string) =>
    httpClient.post<GameDto>(`/admin/games`, { roomId }),

  editGame: (id: string, dto: EditGameDto) =>
    httpClient.put<GameDto>(`/admin/games/${id}`, dto),

  getPlayersGame: (id: string) =>
    httpClient.get<PlayerGames[]>(`/admin/games/${id}/players`),

  getPlayerGameById: (id: string, userId: string) =>
    httpClient.get<OnePlayerGames>(`/admin/games/${id}/players/${userId}`),
  ...
  createGameTurn: (id: string) =>
    httpClient.post<TurnInGame>(`/admin/games/${id}/turns`),

  editGameTurn: (turnId: string, dto: EditTurnInGame) =>
    httpClient.put(`/admin/games/turns/${turnId}`, dto),

  getGameCards: (id: string) =>
    httpClient.get<GameCardDto[]>(`/admin/games/${id}/cards`),

  getGameCardById: (cardId: string) =>
    httpClient.get<GameCardDto>(`/admin/games/cards/${cardId}`),
  ...
  getGameActionById: (actionId: string) =>
    httpClient.get<GameActionDto>(`/admin/games/attack-actions/${actionId}`),

  createGameAction: (dto: CreateGameAction) =>
    httpClient.post<GameActionDto>("/admin/games/attack-actions", dto),

  editGameAction: (id: string, dto: CreateGameAction) =>
    httpClient.put<GameActionDto>(`/admin/games/attack-actions/${id}`, dto),
  ...
  getGameCardMovementById: (id: string) =>
    httpClient.get<GameCardMovementsDto>(`/admin/games/card-movements/${id}`),

  createGameCardMovements: (dto: CreateGameCardMovementsDto) =>
    httpClient.post<GameCardMovementsDto>(`/admin/games/card-movements`, dto),

  editGameCardMovements: (id: string, dto: CreateGameCardMovementsDto) =>
    httpClient.put<GameCardMovementsDto>(
      `/admin/games/card-movements/${id}`,
      dto,
    ),
  ...
  getGamePlaceActionById: (actionId: string) =>
    httpClient.get<GamePlaceActionDto>(
      `/admin/games/place-actions/${actionId}`,
    ),

  createGamePlaceAction: (dto: CreateGamePlaceAction) =>
    httpClient.post<GamePlaceActionDto>("/admin/games/place-actions", dto),

  editGamePlaceAction: (id: string, dto: CreateGamePlaceAction) =>
    httpClient.put<GamePlaceActionDto>(`/admin/games/place-actions/${id}`, dto),

  deleteGamePlaceAction: (id: string) =>
